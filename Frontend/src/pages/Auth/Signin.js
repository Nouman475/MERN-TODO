...
export default function Login() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios
      .post(`${window.location.origin}/api/v1/login`, credentials)
      .then((res) => {
        if (res.data.message == "User not found, or please signup first") {
          notify(res.data.message, "error");
        } else {
          setIsRegistered(true);
          localStorage.setItem("user_id", res.data.others._id);
          ...
          <div className="col">
            ...
            >
              ...
              <div id="form">
                ...
                <button id="button-submit" type="submit" onClick={handleSubmit}>
                  Sign In
                </button>
                <p id="p">
                  Don't have an account?
                  <Link to="/auth/register" id="span">
                    Sign Up
                  </Link>
                </p>
              </div>
